...
public class CameraSource {
    ...
    private final int requestedPreviewHeight = 500;
    ...
    private Camera createCamera() throws IOException {
        ...
        int requestedPreviewWidth = displayMetrics.widthPixels;
        int requestedPreviewHeight = displayMetrics.heightPixels;
        //int mmin=Math.min(requestedPreviewWidth,requestedPreviewHeight)/2;
        SizePair sizePair = selectSizePair(camera, requestedPreviewWidth, requestedPreviewHeight);
        //SizePair sizePair = selectSizePair(camera, mmin, mmin);
        if (sizePair == null) {
